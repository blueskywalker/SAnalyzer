...
public class Hangul {
    ...
    private String get() {
        ...
        String ret = cho != 0 ? (new StringBuilder(String.valueOf(cho))).toString() : "";
        ret = (new StringBuilder(String.valueOf(ret))).append(jung != 0 ? (new StringBuilder(String.valueOf(jung))).toString() : "").toString();
        switch (this.jong) {
            case '\000':
                ret = ret;
                break;
